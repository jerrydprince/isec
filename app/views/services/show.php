...
<section class="py-24 relative overflow-hidden bg-slate-900 dark:bg-slate-950 text-white">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-4">
        ...
        <div class="flex flex-col md:flex-row md:items-center gap-6">
            <div class="w-16 h-16 rounded-3xl bg-accent/20 flex items-center justify-center text-accent text-3xl font-bold border border-accent/20 flex-shrink-0">
                <i class="fa-solid <?= e($service['icon']) ?>"></i>
            </div>
            <div>
                <h1 class="text-3xl sm:text-5xl font-extrabold tracking-tight"><?= e($service['title']) ?></h1>
                <p class="text-slate-300 font-light mt-2 text-sm max-w-xl">Consultancy Framework & System Engineering Blueprint</p>
            </div>
        </div>
    </div>
</section>
